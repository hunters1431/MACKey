...
### 3️⃣ 程序坞快捷键
前 10 个程序坞应用**开箱即用**，自动绑定 `⌃1`…`⌃0`，按下秒速启动 / 切换；也可随时改成你顺手的键。灵感来自经典工具 Snap。

> 💡 **缘起**：Snap 是一款经典的 Intel 应用，却始终未推出 Apple 芯片原生版本。随着苹果即将停止对 Intel 应用的支持，Snap 终将无法运行 —— MACKey 正是为填补这一空缺而生，原生适配 Apple 芯片。
